...
@Provider
public class MyDateConverterProvider implements ParamConverterProvider { //It registers converters for MyDate type
	...
	public <T> ParamConverter<T> getConverter(Class<T> rawType, Type genericType, Annotation[] annotations) {
		...
		if(rawType.getName().equals(MyDate.class.getName())){
			...
			return new ParamConverter<T>() { //Implementing ParamConverter using Anonymous inner class
